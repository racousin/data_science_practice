...
def build_bike() -> dict:
    ...
    return notebook([
        ...
        md("Look at the `count` row of `describe()` before the statistics. It is",
        ...
        md("### 3e. What correlates with what",
           "",
        ...
        md("No summer, and only the second year. You are being asked to forecast",
        ...
        md("Now the words. `pd.get_dummies` one-hot encodes every non-numeric",
        ...
        md("---", "", "## 5. Hold out a validation set the way you will be scored",
           "",
        ...
        code(
            ...
            '-> -MAE {-mean_absolute_error(b_va, pred_va):.2f}")',
            'print(f"RMSE {np.sqrt(mean_squared_error(b_va, pred_va)):.2f}")',
        ),
        md("The challenge ranks on **−MAE** — mean absolute error, negated so that",
        ...
        md("About **−97** against about **−146**, and the honest one is the second.",
        ...
        md("---", "", "## 6. Predict the test set and submit",
           "",
        ...
        md("That scores about **−139**. It is the challenge's declared benchmark:",
        ...
        md("From about **−146 to −108** on the holdout, with the same model, the",
        ...
        md("### 7b. Make the missingness a feature, and multiply two columns",
           "",
        ...
        code(
            ...
            "",
            'print(f"+ missing flags + interaction  -MAE '
            '{score_time_holdout(fe2_train, y_train):.2f}")',
        ),
        md("A small gain, and small is the honest result — the flags say the",
        ...
        md("---", "", "## 8. Submit the engineered model",
           "",
        ...
        md("When a version beats section 7 on the holdout, re-run section 8 with",
...
def build_bank() -> dict:
    ...
    return notebook([
        ...
        md("---", "", "## 7. Go further: put the shapes you saw into the columns",
           ...
           "moves the **holdout** F1. Bins, cut points and category lists are",
           "numbers learned from data — learn them on the training half only,",
           "or your holdout is measuring a model that has already seen it.",
           "",
           "For calibration: the baseline with a tuned threshold lands near",
           "**F1 = 0.58** on this split, and re-cut columns are worth roughly",
        ...
        md("---", "", "## 10. Write down what you did",
           ...
           "  what the holdout said about each.",
           "",
