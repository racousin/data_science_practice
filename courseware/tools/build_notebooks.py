...
def build_bike() -> dict:
    ...
    return notebook([
        ...
        md("So the model does carry real signal — but it also predicts a negative",
           "number of bicycles a hundred-odd times, exactly as plot 3a warned.",
        ...
        md("---", "", "## 8. Where to go from here",
           ...
           "",
           "That is well below the −97 section 5 printed, and the reason is the",
           "split: the challenge holds out the *last* five months, while your",
           "holdout was drawn at random from hours the model then fitted all",
           "around. Which split tells the truth, and how to build one that does,",
           "is the first lesson of Session 3.",
           "",
