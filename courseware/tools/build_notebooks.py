...
def build_bike() -> dict:
    ...
    return notebook([
        ...
        md("---", "", "## 8. Where to go from here",
           "",
           "This model scores about **−MAE = −104** on the challenge's test set.",
           "The challenge page lists the rungs above it; the first is worth far",
           "more than you would expect, and it is not a change of model:",
           "",
           ...
           "  `get_dummies` and re-run — on the test split it takes −MAE from",
           "  −104 to about −74, with the same `LinearRegression`.",
