...
![Linear regression cannot model a probability](assets/s2-ml-foundations/logistic-regression/linear-vs-logistic-fit.png)
...
![The sigmoid curve](assets/s2-ml-foundations/logistic-regression/sigmoid-curve.png)
...
![Convex versus non-convex loss surfaces](assets/s2-ml-foundations/logistic-regression/convex-vs-nonconvex.png)
...
![Gradient descent trajectory for a classifier](assets/s2-ml-foundations/logistic-regression/gd-trajectory-classification.gif)
