...
![A graph of snapshots](assets/s1-git-and-packaging/why-version-control/commit-graph.png)
...
![The three trees](assets/s1-git-and-packaging/why-version-control/three-trees.png)
