...
![A wide MLP and a deep MLP](assets/s3-models-and-tuning/training-neural-networks/wide-vs-deep-mlp.png)
...
![Batch size and epoch](assets/s3-models-and-tuning/training-neural-networks/batch-and-epoch.png)
...
![Training and validation error against iterations](assets/s3-models-and-tuning/training-neural-networks/early-stopping.png)
