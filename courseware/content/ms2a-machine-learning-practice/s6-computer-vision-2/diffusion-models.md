...
![Forward noising and learned reverse](assets/cv/diffusion-process.png)
...
![Invertible transformation between distributions](assets/cv/normalizing-flow-diagram.png)
