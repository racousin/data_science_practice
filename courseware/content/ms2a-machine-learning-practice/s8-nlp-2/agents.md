...
![An LLM replacing the decision step of a classical agent loop](assets/nlp/agentic.jpg)
...
![The generate–critique–revise loop](assets/nlp/reflexion.png)
...
![Multi-agent architectures: supervisor, pipeline, debate](assets/nlp/agenticarch.gif)
