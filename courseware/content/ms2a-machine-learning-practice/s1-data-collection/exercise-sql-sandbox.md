...
- [ ] `DATABASE_URL` and `WRITER_URL` are read with `os.environ[...]`, and neither password is in your code, notebooks or git history
...
## Did you validate this walkthrough? (continued)
