...
![Max pooling and average pooling over 2x2 windows](/api/academic_courses/assets/lessons/87/pooling.png)
...
![A LeNet-style CNN on MNIST](/api/academic_courses/assets/lessons/87/cnn-network.jpg)
