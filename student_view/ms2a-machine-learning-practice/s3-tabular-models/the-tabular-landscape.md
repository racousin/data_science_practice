...
![k-nearest neighbours](/api/academic_courses/assets/lessons/71/knn.png)
...
![Maximum-margin separator](/api/academic_courses/assets/lessons/71/svm.png)
...
![A decision tree](/api/academic_courses/assets/lessons/71/tree.png)
...
![Choosing a split by weighted Gini impurity](/api/academic_courses/assets/lessons/71/gini.png)
