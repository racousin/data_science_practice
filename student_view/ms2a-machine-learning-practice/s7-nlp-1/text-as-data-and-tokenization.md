...
![Sequential structure in text](/api/academic_courses/assets/lessons/97/NatureofText.png)
...
![ASCII code table](/api/academic_courses/assets/lessons/97/ascii.png)
...
![ASCII versus Unicode](/api/academic_courses/assets/lessons/97/utf.png)
...
![From text to tokens to ids and back](/api/academic_courses/assets/lessons/97/tokenize1.jpg)
...
![BPE merges on a small corpus](/api/academic_courses/assets/lessons/97/bpe.png)
