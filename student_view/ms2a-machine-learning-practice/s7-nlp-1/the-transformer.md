...
![A residual connection around a sublayer](/api/academic_courses/assets/lessons/101/residual_connection.png)
...
![Positional encoding added to token embeddings](/api/academic_courses/assets/lessons/101/position.png)
...
![Encoder and decoder stacks](/api/academic_courses/assets/lessons/101/transformer.png)
...
![Encoder-only, decoder-only, encoder-decoder](/api/academic_courses/assets/lessons/101/bertgpt.png)
...
![The CLS token as a sequence representation](/api/academic_courses/assets/lessons/101/cls.png)
