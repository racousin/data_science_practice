...
![Recurrent units unrolled over time](/api/academic_courses/assets/lessons/99/rnns.png)
...
![Forward and backward passes concatenated](/api/academic_courses/assets/lessons/99/birnn.png)
...
![Encoder, context vector, decoder](/api/academic_courses/assets/lessons/99/seq2seq.png)
