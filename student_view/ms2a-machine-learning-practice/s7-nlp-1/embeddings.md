...
![Words positioned in a learned vector space](/api/academic_courses/assets/lessons/98/word_embeddings.png)
...
![Skip-gram and CBOW](/api/academic_courses/assets/lessons/98/word2vec.png)
...
![Analogies as directions in embedding space](/api/academic_courses/assets/lessons/98/vector-arithmetic.png)
...
![Cosine similarity by angle](/api/academic_courses/assets/lessons/98/cosine.png)
...
![The same word, different vectors by context](/api/academic_courses/assets/lessons/98/contextual_embed.png)
...
![Pairwise cosine similarity of sentences](/api/academic_courses/assets/lessons/98/Heatmap-cosine.png)
...
![Semantic clusters in embedding space](/api/academic_courses/assets/lessons/98/semantic-clustering.png)
