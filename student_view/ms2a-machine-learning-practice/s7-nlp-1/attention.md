...
![Query, key and value projections](/api/academic_courses/assets/lessons/100/qkv.png)
...
![Self-attention over a sequence](/api/academic_courses/assets/lessons/100/self-attention.png)
...
![Twelve BERT heads on one sentence](/api/academic_courses/assets/lessons/100/head.png)
...
![Heads run in parallel and are concatenated](/api/academic_courses/assets/lessons/100/multihead.png)
...
![Cross-attention between two sequences](/api/academic_courses/assets/lessons/100/cross_attention.png)
...
![Padding and causal masks](/api/academic_courses/assets/lessons/100/mask.png)
