...
![Zero-shot and few-shot use of a pretrained model versus transfer](/api/academic_courses/assets/lessons/105/zero-shot-vs-transfer.png)
...
![In-context learning: examples in the prompt shape the output](/api/academic_courses/assets/lessons/105/prompteng.png)
...
![Full fine-tuning versus parameter-efficient adaptation](/api/academic_courses/assets/lessons/105/finetune2.jpeg)
...
![Low-rank decomposition of the weight update](/api/academic_courses/assets/lessons/105/loracompute.png)
...
![LoRA adapters alongside the frozen projection](/api/academic_courses/assets/lessons/105/loraFlow.gif)
...
![The Hugging Face ecosystem](/api/academic_courses/assets/lessons/105/huggingface-ecosystem.png)
