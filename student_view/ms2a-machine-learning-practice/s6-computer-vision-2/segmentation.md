...
![Per-pixel labels](/api/academic_courses/assets/lessons/92/segmentation-intro.png)
...
![Semantic, instance, panoptic](/api/academic_courses/assets/lessons/92/segmentation-types-comparison.jpg)
...
![U-Net](/api/academic_courses/assets/lessons/92/unet-architecture.png)
...
![Atrous spatial pyramid pooling](/api/academic_courses/assets/lessons/92/deeplab-aspp.png)
...
![Mask R-CNN](/api/academic_courses/assets/lessons/92/mask-rcnn-architecture.png)
...
![Dice versus IoU](/api/academic_courses/assets/lessons/92/dicevsiou.png)
