...
![Detections with boxes and labels](/api/academic_courses/assets/lessons/91/object-detection-examples.jpeg)
...
![Intersection over union](/api/academic_courses/assets/lessons/91/iou-visualization.png)
...
![Faster R-CNN](/api/academic_courses/assets/lessons/91/faster-rcnn-architecture.jpg)
...
![The YOLO grid](/api/academic_courses/assets/lessons/91/yolo-grid.png)
...
![DETR](/api/academic_courses/assets/lessons/91/detr-architecture.png)
