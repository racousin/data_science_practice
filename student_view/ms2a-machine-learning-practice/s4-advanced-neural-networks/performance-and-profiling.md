...
![Average time per training-loop component](/api/academic_courses/assets/lessons/83/time.png)
...
![Forward versus backward FLOPs per layer](/api/academic_courses/assets/lessons/83/flop.png)
...
![CPU versus GPU forward time across batch sizes](/api/academic_courses/assets/lessons/83/cpugpubatch.png)
...
![CPU-GPU memory transfer time by payload size](/api/academic_courses/assets/lessons/83/overhead.png)
...
![Mixed-precision training: FP16 compute with an FP32 master copy](/api/academic_courses/assets/lessons/83/mixed.jpg)
...
![Memory distribution of a small MLP trained with Adam](/api/academic_courses/assets/lessons/83/distribution.png)
