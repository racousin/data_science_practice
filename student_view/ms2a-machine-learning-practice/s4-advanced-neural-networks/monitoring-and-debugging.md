...
![TensorBoard scalar panel, two runs](/api/academic_courses/assets/lessons/82/Loss.png)
...
![Training loss alone over ten epochs](/api/academic_courses/assets/lessons/82/training_history.png)
...
![Training and validation loss over 200 epochs](/api/academic_courses/assets/lessons/82/training_validation_loss.png)
...
![Gradient distribution of one layer across training steps](/api/academic_courses/assets/lessons/82/histogram.png)
...
![TensorBoard computation graph](/api/academic_courses/assets/lessons/82/tensorboard_graph.png)

![TensorBoard embedding projector](/api/academic_courses/assets/lessons/82/embedding_projector.png)
