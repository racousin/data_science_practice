...
![9 observations, 2 variables](/api/academic_courses/assets/lessons/166/temperature-2var.png)

![9 observations, 3 variables](/api/academic_courses/assets/lessons/166/temperature-3d.png)
...
> **Reference — pandas & seaborn** in Session 1, with a runnable Colab notebook
> alongside it. If `groupby`, `get_dummies` or `pairplot` are unfamiliar, run
> that notebook first — it takes twenty minutes and every session after this one
> assumes it.
...
![All six pairs of the four numeric variables, coloured by species](/api/academic_courses/assets/lessons/166/penguins-pairplot.png)
...
![Features and label in a table](/api/academic_courses/assets/lessons/166/features-and-label.png)
...
![Supervised, unsupervised, reinforcement learning](/api/academic_courses/assets/lessons/166/learning-types.png)
...
![The same features under a continuous and a discrete target](/api/academic_courses/assets/lessons/166/penguins-targets.png)
