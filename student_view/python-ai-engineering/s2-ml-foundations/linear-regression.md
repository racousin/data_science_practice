...
![A line in 2D, a plane in 3D](/api/academic_courses/assets/lessons/150/regression-line-and-plane.png)
...
![Gradient descent trajectory in parameter space](/api/academic_courses/assets/lessons/150/gd-trajectory-regression.gif)
