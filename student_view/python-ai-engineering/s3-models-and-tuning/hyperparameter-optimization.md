...
![Grid search versus random search](/api/academic_courses/assets/lessons/162/grid-vs-random-search.png)
...
![Selecting among candidates](/api/academic_courses/assets/lessons/162/model-selection-flow.png)
