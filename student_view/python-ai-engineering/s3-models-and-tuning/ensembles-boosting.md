...
![Weak learners combined into a strong one](/api/academic_courses/assets/lessons/161/boosting-weak-learners.png)
...
![Bagging and boosting from the same building block](/api/academic_courses/assets/lessons/161/bagging-vs-boosting.png)
