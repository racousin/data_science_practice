...
![A branch is a pointer](/api/academic_courses/assets/lessons/30/branch-pointers.png)
...
![Merge versus rebase](/api/academic_courses/assets/lessons/30/merge-vs-rebase.png)
...
![The pull-request loop](/api/academic_courses/assets/lessons/30/pr-lifecycle.png)
