...
# Usage: ./exercise2.sh <username> <current_utc_time> <aws-access-key-id> <aws-secret-access-key> <aws-region>
...
RESULT_FILE="${RESULTS_DIR}/module${MODULE_NUMBER}_exercise2.json"  # File to store this exercise's results
IS_LOWER=false
