...
const Exercise1 = () => {
  const trainDataUrl =
    ...
    "/modules/module11/exercise/module11_exercise_train.csv";
  const testDataUrl =
    process.env.PUBLIC_URL +
    "/modules/module11/exercise/module11_exercise_test.csv";
  const notebookUrl =
    process.env.PUBLIC_URL +
    "/modules/module11/exercise/module11_exercise.ipynb";
  const notebookHtmlUrl =
    process.env.PUBLIC_URL +
    "/modules/module11/exercise/module11_exercise.html";
  const notebookColabUrl =
    process.env.PUBLIC_URL +
    "website/public/modules/module11/exercise/module11_exercise.ipynb";
  const metadata = {
    description:
        ...
        <Col>
          ...
          <ol>
            ...
            <li>
              ...
              <code>module11</code> directory under your username folder.
            </li>
            <li>
