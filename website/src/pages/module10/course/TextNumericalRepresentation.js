...
# The two embeddings for 'bank' will differ based on context
      ...
      <Title order={3} id="embeddings-comparison" mb="sm">
        ...
        <Table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Zero vector for OOV</td>
              <td>Low</td>
            </tr>
            <tr>
              <td>Word2Vec</td>
              <td>Configurable (typically 100-300)</td>
              <td>Local window</td>
              <td>Poor</td>
              <td>Medium</td>
            </tr>
            <tr>
              <td>GloVe</td>
              <td>Configurable (typically 50-300)</td>
            ...
            <tr>
              ...
              <td>Configurable (typically 100-300)</td>
              <td>Local window</td>
              <td>Good (subword information)</td>
              <td>Medium-High</td>
            </tr>
            <tr>
              <td>BERT/Contextual</td>
              <td>768-1024 per token</td>
              <td>Full bidirectional context</td>
              <td>Good (subword tokenization)</td>
              <td>Very High</td>
            </tr>
          </tbody>
        </Table>
      ...
      <Text>
        In this module, we've explored the fundamental techniques for numerically representing text data.
        Tokenization and embedding methods form the backbone of modern NLP systems, enabling machines to process
        and understand human language. As we progress through the course, we'll build on these representations
        to develop sophisticated NLP models for various applications.
      </Text>
    </Container>
  );
};
