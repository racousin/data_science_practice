            ...
            <Stack spacing="md">
              ...
              <Box className="p-4 border rounded bg-gray-50">
                ...
                <List>
                  ...
                  <List.Item><strong>Special Tokens:</strong> [CLS], [SEP], [MASK]</List.Item>
                </List>
              </Box>
              ...
              <Title order={3} mt="lg">Input Format and Data Processing</Title>
              <Text>
              ...
              <List>
                ...
                <List.Item><strong>[SEP]:</strong> Separator token, used to separate different sentences</List.Item>
                <List.Item><strong>[MASK]:</strong> Used to mask tokens during pre-training</List.Item>
              </List>
