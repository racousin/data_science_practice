...
const CourseReinforcementLearning = () => {
  const courseLinks = [
    {
      ...
      component: lazy(() => import("pages/module12/course/MDP")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/module12/course/DynamicProgramming")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/module12/course/ModelFreeMethods")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/module12/course/DeepRL")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() =>
        import("pages/module12/course/ExplorationExploitation")
      ),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/module12/course/AdvancedTopics")),
      subLinks: [
    ...
    },
    {
      to: "/RL frameworks",
      label: "RL frameworks",
      component: lazy(() => import("pages/module12/course/RL_frameworks")),
      subLinks: [],
    },
    // {
    //   to: "/case-study",
    //   label: "Case Study",
    //   component: lazy(() => import("pages/module12/course/CaseStudy")),
    // },
  ];
  ...
  return (
    <ModuleFrame
      module={module}
      isCourse={true}
      title="Module 12: Reinforcement Learning"
