    ...
    <Container fluid>
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Image
            src="/assets/module12/tikz_images_2/tax.png"
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Image
            src="/assets/module12/tikz_images_2/explore_vs_exploit.jpeg"
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Row>
            <Col md={4}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_1.png"
            ...
            <Col md={4}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_2.png"
                alt="Evaluate Q"
                fluid
              />
            ...
            <Col md={4}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_3.png"
                alt="Iterate"
                fluid
              />
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Row>
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_4.png"
                alt="SARSA Step 1"
                fluid
              />
              <p className="text-center">
            ...
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_5.png"
                alt="SARSA Step 2"
                fluid
              />
              <p className="text-center">
            ...
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_6.png"
                alt="SARSA Step 3"
                fluid
              />
              <p className="text-center">
            ...
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_7.png"
                alt="SARSA Step 4"
                fluid
              />
              <p className="text-center">
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Row>
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_8.png"
            ...
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_9.png"
            ...
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_10.png"
            ...
            <Col md={3}>
              <Image
                src="/assets/module12/tikz_images_2/tikz_picture_11.png"
