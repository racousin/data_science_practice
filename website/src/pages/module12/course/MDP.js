    ...
    <Container fluid>
      ...
      <Row className="mt-4">
        <Col>
          ...
          <div className="text-center">
            <Image
              src="/assets/module12/tikz_picture_1.png"
              alt="Grid World"
              fluid
            />
            <p>A: Agent, G: Goal</p>
      ...
      <Row className="mt-4">
        <Col md={6}>
          ...
          <Image
            src="/assets/module12/tikz_picture_2.png"
            alt="State Space"
            fluid
          />
        </Col>
        <Col md={6}>
          ...
          <Image
            src="/assets/module12/tikz_picture_3.png"
            alt="Action Space"
            fluid
          />
        </Col>
        ...
        <Col>
          ...
          <Row>
            <Col md={6}>
              ...
              <Image
                src="/assets/module12/tikz_picture_4.png"
            ...
            <Col md={6}>
              ...
              <Image
                src="/assets/module12/tikz_picture_5.png"
        ...
        <Col>
          ...
          <Row>
            <Col md={6}>
              ...
              <Image
                src="/assets/module12/tikz_picture_6.png"
                alt="Simple Reward"
                fluid
              />
            </Col>
            <Col md={6}>
              ...
              <Image
                src="/assets/module12/tikz_picture_7.png"
                alt="Complex Reward"
                fluid
              />
            </Col>
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Image src="/assets/module12/tikz_picture_8.png" alt="Policy" fluid />
        </Col>
      </Row>
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Image
            src="/assets/module12/tikz_picture_9.png"
            alt="Trajectory"
            fluid
          />
        </Col>
      ...
      <Row className="mt-4">
        ...
        <Row>
          <Col md={6}>
            ...
            <Image
              src="/assets/module12/tikz_picture_10.png"
              alt="Return"
              fluid
            />
          </Col>
          <Col md={6}>
            ...
            <Image
              src="/assets/module12/tikz_picture_11.png"
              alt="Optimal Policy"
              fluid
            />
          </Col>
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Image
            src="/assets/module12/tikz_picture_12.png"
            alt="Optimal Policy"
            fluid
          />
        </Col>
    ...
    for step in range(max_steps):
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Image
            src="/assets/module12/tikz_picture_13.png"
            alt="Value Function"
            fluid
          />
        </Col>
      ...
      <Row className="mt-4">
        <Col>
          ...
          <Image
            src="/assets/module12/tikz_picture_14.png"
    ...
    `}
      ...
      <Row className="mt-4">
        <Col>
          ...
          <div className="text-center">
            <Image
              src="/assets/module12/tikz_picture_15.png"
