...
torch.jit.save(optimized_model, "model.pt")`} />
        ...
        <div data-slide>
          ...
          <Paper className="p-6 bg-gradient-to-r from-purple-50 to-pink-50 mb-6">
            <Title order={3} mb="md">2. Tensor Definition</Title>
            <Text size="lg" mb="md">
            ...
            <Grid gutter="lg" className="mt-6">
              <Grid.Col span={6}>
                <Paper className="p-4 bg-white">
                  <Title order={4} mb="sm">Core Attributes</Title>
                  <List size="sm">
                    <List.Item><strong>shape:</strong> Tuple defining dimensions (e.g., [3, 4, 5])</List.Item>
                    <List.Item><strong>strides:</strong> Memory offsets between consecutive elements</List.Item>
                    <List.Item><strong>dtype:</strong> Data type (float32, int64, bool, complex64)</List.Item>
                    <List.Item><strong>layout:</strong> Memory layout (strided or sparse)</List.Item>
                    <List.Item><strong>storage:</strong> Underlying 1D array in memory</List.Item>
                    <List.Item><strong>device:</strong> Computation location (cpu, cuda:0)</List.Item>
                  </List>
                </Paper>
              </Grid.Col>
