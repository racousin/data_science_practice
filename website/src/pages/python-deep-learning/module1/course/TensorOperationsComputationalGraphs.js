      ...
      <Stack spacing="xl">
        ...
        <div id="tensor-algebra">
          ...
          <Paper className="p-6 bg-blue-50 mb-6">
            <Title order={3} className="mb-4">Mathematical Foundation of Tensors</Title>
            <Text className="mb-4">
...
print(f"L2 norm: {l2_norm:.4f}")`} />
        ...
        {/* Broadcasting */}
        <div id="broadcasting">
          <Title order={2} className="mb-6">Broadcasting Mechanics & Memory</Title>
          
          <Paper className="p-6 bg-gray-50 mb-6">
            <Title order={3} className="mb-4">Broadcasting Rules</Title>
            <Text className="mb-4">
...
memory_analysis()`} />
        ...
        <div id="storage-views">
          <Title order={2} className="mb-6">Storage, Views & Memory Layout</Title>
          
          <Paper className="p-6 bg-blue-50 mb-6">
            <Title order={3} className="mb-4">PyTorch Memory Model</Title>
            <Text className="mb-4">
...
explain_strides(z)`} />
        ...
        <div id="computational-graphs">
          <Title order={2} className="mb-6">Introduction to Computational Graphs</Title>
          
          <Paper className="p-6 bg-gray-50 mb-6">
            <Title order={3} className="mb-4">Computational Graph Concepts</Title>
            <Text className="mb-4">
          ...
          <Grid gutter="lg">
            <Grid.Col span={6}>
              <Paper className="p-6 bg-gradient-to-br from-blue-50 to-blue-100 h-full">
                <Title order={3} className="mb-4">Key Tensor Concepts</Title>
                <List spacing="md">
            ...
            <Grid.Col span={6}>
              <Paper className="p-6 bg-gradient-to-br from-green-50 to-green-100 h-full">
                <Title order={3} className="mb-4">Computational Graph Insights</Title>
                <List spacing="md">
