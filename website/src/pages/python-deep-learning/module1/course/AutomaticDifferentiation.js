  ...
  return (
    <Container size="xl">
      <Stack spacing="xl">
        ...
        {/* Computation Graphs */}
        <div id="computation-graph">
          <Title order={2} className="mb-6">Computation Graphs</Title>
...
print(f"loss.grad_fn: {loss.grad_fn}")  # PowBackward`} />
        ...
        <div id="gradient-computation">
          <Title order={2} className="mb-6">Gradient Computation Process</Title>
...
print("Manual: ∂f/∂x = 22, ∂f/∂y = 17")`} />
        ...
        <div id="backward-pass">
          <Title order={2} className="mb-6">The Backward Pass in Detail</Title>
...
print(f"\\nGradients: x.grad={x.grad:.4f}, y.grad={y.grad:.4f}")`} />
        ...
        <div id="gradient-accumulation">
          <Title order={2} className="mb-6">Gradient Accumulation</Title>
...
for epoch in range(3):
    ...
    # DON'T FORGET: optimizer.zero_grad() at the start!`} />
        ...
        <div id="higher-order-gradients">
          <Title order={2} className="mb-6">Higher-order Gradients</Title>
          ...
          <Grid gutter="lg">
            ...
            <Grid.Col span={6}>
              <Paper className="p-6 bg-gradient-to-br from-green-50 to-green-100 h-full">
                <Title order={3} className="mb-4">Practical Impact</Title>
                <List spacing="md">
