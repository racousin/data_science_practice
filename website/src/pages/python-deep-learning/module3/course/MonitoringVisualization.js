...
writer = SummaryWriter('runs/experiment_1')`} />
              ...
              <Text mt="md" mb="sm">Add the model graph/scalar/histogram/image/embedding object to TensorBoard folder:</Text>
...
writer.close()`} />
                ...
                <Text size="sm" mt="sm">Then navigate to <code>http://localhost:6006</code></Text>
...
writer.add_image('Batch_Samples', grid, epoch)`} />
            ...
            <div>
              ...
              Embeddings convert discrete, categorical data (like words, items, users) into continuous vector representations that capture meaningful relationships and similarities.
