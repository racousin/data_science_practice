...
print(f"std=2.0: {relu_chain(10, 2.0):.2e}")`} />
          ...
          <Title order={3} mb="md">Practical Detection and Solutions</Title>
          
          <Grid gutter="lg">
            <Grid.Col span={6}>
              <Paper className="p-4">
                <Title order={4} mb="sm">Detecting Vanishing Gradients</Title>
                <CodeBlock language="python" code={`# Monitor gradient health during training
...
# - Mean ≈ 0, std ≈ 0`} />
                ...
                <List>
                  <List.Item>Use ReLU, LeakyReLU, or ELU activations</List.Item>
                  <List.Item>Proper weight initialization (Xavier/He)</List.Item>
                  <List.Item>Batch normalization</List.Item>
                  <List.Item>Residual connections (skip connections)</List.Item>
                </List>
              </Paper>
            </Grid.Col>
            ...
            <Grid.Col span={6}>
              <Paper className="p-4">
                <Title order={4} mb="sm">Handling Exploding Gradients</Title>
                <CodeBlock language="python" code={`# Gradient clipping implementation
...
# )`} />
                ...
                <List>
                  <List.Item>Gradient clipping (by norm or value)</List.Item>
                  <List.Item>Careful weight initialization</List.Item>
                  <List.Item>Lower learning rates</List.Item>
                  <List.Item>Layer normalization techniques</List.Item>
                </List>
              </Paper>
            </Grid.Col>
          </Grid>
          ...
          <Paper className="p-6 bg-gray-50 mt-6">
            <Title order={4} mb="md">Key Mathematical Insights</Title>
            <Text>
              The gradient flow problem fundamentally arises from the multiplicative nature of backpropagation:
            </Text>
            <BlockMath math="\text{Gradient} = \text{Local gradient} \times \text{Upstream gradient}" />
            <Text className="mt-4">
              When this multiplication happens across many layers, small values 
              (<InlineMath math="< 1" />) lead to vanishing, while large values 
              (<InlineMath math="> 1" />) lead to explosion. The goal is to maintain 
              gradient magnitudes close to 1 throughout the network.
            </Text>
          </Paper>
        </div>
