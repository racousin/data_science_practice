...
const CourseMLPipelineAndExploratoryDataAnalysis = () => {
  const courseLinks = [
    {
      to: "/Introduction",
      label: "Introduction",
  ...
  const title = `Module 3: ML Pipeline And Exploratory Data Analysis`;
...
export default CourseMLPipelineAndExploratoryDataAnalysis;
