...
const Exercise1 = () => {
  const notebookUrl = process.env.PUBLIC_URL + "/modules/module13/exercise/module13_exercise5.ipynb";
  const notebookHtmlUrl = process.env.PUBLIC_URL + "/modules/module13/exercise/module13_exercise5.html";
  const notebookColabUrl = process.env.PUBLIC_URL + "website/public/modules/module13/exercise/module13_exercise5.ipynb";
