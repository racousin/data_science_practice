...
const Exercise0 = () => {
  const notebookUrl = process.env.PUBLIC_URL + "/modules/module13/exercise/module13_exercise0.ipynb";
  const notebookHtmlUrl = process.env.PUBLIC_URL + "/modules/module13/exercise/module13_exercise0.html";
  const notebookColabUrl = process.env.PUBLIC_URL + "website/public/modules/module13/exercise/module13_exercise0.ipynb";
