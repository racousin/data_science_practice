  ...
  const courseLinks = [
    {
      to: "/introduction",
      label: "Introduction",
      component: lazy(() => import("pages/data-science-practice/module1/course/Introduction")),
    },
    {
      to: "/installing-git",
      label: "Installing Git",
      component: lazy(() => import("pages/data-science-practice/module1/course/InstallingGit")),
      subLinks: [
        { id: "mac", label: "Mac" },
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module1/course/FirstStepsWithGit")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module1/course/ConfigureAndAccessGithub")
      ),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module1/course/WorkingWithRemoteRepositories")
      ),
      subLinks: [
        {
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module1/course/BranchingAndMerging")),
      subLinks: [
    ...
    },
    {
      to: "/collaborating",
      label: "Collaborating",
      component: lazy(() => import("pages/data-science-practice/module1/course/Collaborating")),
      subLinks: [
        {
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module1/course/BestPracticesAndResources")
      ),
      subLinks: [
        {
          id: "good-practices",
