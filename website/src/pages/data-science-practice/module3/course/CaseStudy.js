...
const CaseStudy = () => {
  ...
  const notebookUrl =
    process.env.PUBLIC_URL + "/modules/data-science-practice/module3/course/module3_course.ipynb";
  const notebookHtmlUrl =
    process.env.PUBLIC_URL + "/modules/data-science-practice/module3/course/module3_course.html";
  const notebookColabUrl =
    process.env.PUBLIC_URL +
    "website/public/modules/data-science-practice/module3/course/module3_course.ipynb";
  const metadata = {
    description:
