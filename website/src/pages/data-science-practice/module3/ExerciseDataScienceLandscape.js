  ...
  const exerciseLinks = [
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module3/exercise/Exercise0")),
    },
    {
      to: "/exercise1",
      label: <>Exercise 1<span style={{color: 'red', fontWeight: 'bold'}}>*</span></>,
      component: lazy(() => import("pages/data-science-practice/module3/exercise/Exercise1")),
    },
    {
      to: "/exercise2",
      label: "Exercise 2",
      component: lazy(() => import("pages/data-science-practice/module3/exercise/Exercise2")),
    },
  ];const module = 3;
  return (
    <ModuleFrame
