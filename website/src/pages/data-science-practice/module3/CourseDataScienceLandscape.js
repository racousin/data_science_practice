  ...
  const courseLinks = [
    {
      to: "/Introduction",
      label: "Introduction",
      component: lazy(() => import("pages/data-science-practice/module3/course/Introduction")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module3/course/MachineLearningPipeline")
      ),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module3/course/ModelTrainingPrediction")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module3/course/ModelEvaluationValidation")
      ),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module3/course/EvaluationMetrics")),
      subLinks: [
...

    {
      ...
      component: lazy(() => import("pages/data-science-practice/module3/course/ExploratoryDataAnalysis")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module3/course/CaseStudy")),
    },
    {
      to: "/model-baseline-case-study",
      label: "Model Baseline Case Study",
      component: lazy(() => import("pages/data-science-practice/module3/course/CaseStudyML")),
    },
  ];
