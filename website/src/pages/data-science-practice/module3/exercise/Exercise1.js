...
const Exercise1 = () => {
  ...
  const notebookUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module3/exercise/module3_exercise1.ipynb";
  const notebookHtmlUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module3/exercise/module3_exercise1.html";
  const notebookColabUrl = process.env.PUBLIC_URL + "website/public/modules/data-science-practice/module3/exercise/module3_exercise1.ipynb";
  const metadata = {
