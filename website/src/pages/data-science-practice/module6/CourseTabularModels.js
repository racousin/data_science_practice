  ...
  const courseLinks = [
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module6/course/ModelSelection")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module6/course/HyperparameterOptimization")
      ),
      subLinks: [
    ...
    },
    {
      to: "/models",
      label: "Models",
      component: lazy(() => import("pages/data-science-practice/module6/course/Models")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module6/course/EnsembleModels")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module6/course/EnsembleTechniques")
      ),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module6/course/TimeSeriesModels")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module6/course/AutoML")),
      subLinks: []
    },
    {
      to: "/custom-objectives",
      label: "Custom Objectives Guide",
      component: lazy(() => import("pages/data-science-practice/module6/course/CustomObjectivesGuide")),
      subLinks: [
    ...
    },
    {
      to: "/CaseStudy6",
      label: "Case Study",
      component: lazy(() => import("pages/data-science-practice/module6/course/CaseStudy")),
      subLinks: []
    },
  ];
