...
const CourseRecommendationSystems = () => {
  ...
  //     component: lazy(() => import("pages/data-science-practice/module12/course/Introduction")),
  //     subLinks: [
  //       {
  ...
  //     component: lazy(() =>
  //       import("pages/data-science-practice/module12/course/ContentBasedFiltering")
  //     ),
  //     subLinks: [
  ...
  //     component: lazy(() =>
  //       import("pages/data-science-practice/module12/course/CollaborativeFiltering")
  //     ),
  //     subLinks: [
  ...
  //     component: lazy(() => import("pages/data-science-practice/module12/course/HybridMethods")),
  //     subLinks: [
  ...
  //     component: lazy(() =>
  //       import("pages/data-science-practice/module12/course/DeepLearningRecommendations")
  //     ),
  //     subLinks: [
  //       {
  ...
  //     component: lazy(() =>
  //       import("pages/data-science-practice/module12/course/ContextAwareRecommendations")
  //     ),
  //     subLinks: [
  ...
  //     component: lazy(() => import("pages/data-science-practice/module12/course/EvaluationMetrics")),
  //     subLinks: [
  ...
  //     component: lazy(() => import("pages/data-science-practice/module12/course/ColdStartProblem")),
  //     subLinks: [
  ...
  //     to: "/CaseStudy11",
  //     label: "CaseStudy",
  //     component: lazy(() => import("pages/data-science-practice/module5/course/CaseStudy")),
  //   },
  // ];
