  ...
  const courseLinks = [
    {
      to: "/introduction",
      label: "Introduction",
      component: lazy(() => import("pages/data-science-practice/module4/course/Introduction")),
      subLinks: [
...

    {
      to: "/files",
      label: "Files",
      component: lazy(() => import("pages/data-science-practice/module4/course/Files")),
      subLinks: [
    ...
    },
    {
      to: "/databases",
      label: "Databases",
      component: lazy(() => import("pages/data-science-practice/module4/course/Databases")),
      subLinks: [
    ...
    },
    {
      to: "/apis",
      label: "APIs",
      component: lazy(() => import("pages/data-science-practice/module4/course/APIs")),
      subLinks: [
    ...
    },
    {
      to: "/web-scraping",
      label: "Web Scraping",
      component: lazy(() => import("pages/data-science-practice/module4/course/WebScraping")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module4/course/BatchVsStreaming")),
      subLinks: [
    ...
    },
    {
      to: "/data-quality",
      label: "Data Quality",
      component: lazy(() => import("pages/data-science-practice/module4/course/DataQuality")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module4/course/ManipulatingSources")),
      subLinks: [
    ...
    },
    {
      to: "/case-study",
      label: "Case Study",
      component: lazy(() => import("pages/data-science-practice/module4/course/CaseStudy")),
    },
  ];
