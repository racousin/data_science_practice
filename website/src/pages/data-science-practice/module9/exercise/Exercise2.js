...
const Exercise2 = () => {
  const notebookUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module9/exercise/module9_exercise2.ipynb";
  const notebookHtmlUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module9/exercise/module9_exercise2.html";
  const notebookColabUrl = process.env.PUBLIC_URL + "website/public/modules/data-science-practice/module9/exercise/module9_exercise2.ipynb";
    ...
    <Container fluid>
      <Stack spacing="xl" className="p-6">
        ...
        <Text className="text-gray-700">
          ...
          for evaluation. Your agent will need to achieve a mean reward of at least 0.35 over runs to be validated.
        </Text>
