...
const Exercise2 = () => {
  const notebookUrl = process.env.PUBLIC_URL + "/modules/module10/exercise/module10_exercise2.ipynb";
  const notebookHtmlUrl = process.env.PUBLIC_URL + "/modules/module10/exercise/module10_exercise2.html";
  const notebookColabUrl = process.env.PUBLIC_URL + "website/public/modules/module10/exercise/module10_exercise2.ipynb";
