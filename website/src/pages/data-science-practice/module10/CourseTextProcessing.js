  ...
  const courseLinks = [
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module10/course/Introduction")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module10/course/TextNumericalRepresentation")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module10/course/RNN")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module10/course/TransformerComponents")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module10/course/TransformerArchitectures")),
      subLinks: [
      ],
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module10/course/TransferLearning")),
      subLinks: [
      ],
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module10/course/NLPEvaluation")),
      subLinks: [
      ],
    },
    // {
    ...
    //   component: lazy(() => import("pages/data-science-practice/module10/course/RAG")),
    //   subLinks: [
    ...
    //   to: "/casestudy",
    //   label: "Case Study",
    //   component: lazy(() => import("pages/data-science-practice/module10/course/CaseStudy")),
    //   subLinks: [
