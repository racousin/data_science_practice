  ...
  const courseLinks = [
    {
      to: "/introduction",
      label: "Introduction",
      component: lazy(() => import("pages/data-science-practice/module2/course/Introduction")),
    },
    {
      to: "/install-python",
      label: "Install Python",
      component: lazy(() => import("pages/data-science-practice/module2/course/InstallPython")),
      subLinks: [
        { id: "mac", label: "Mac" },
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module2/course/SettingUpPythonEnvironment")
      ),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module2/course/InstallingPackages")),
      subLinks: [
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module2/course/BuildingPackages")),
      subLinks: [
        {
    ...
    },
    {
      ...
      component: lazy(() => import("pages/data-science-practice/module2/course/BestPracticesAndRessources")
      ),
      subLinks: [
        {
