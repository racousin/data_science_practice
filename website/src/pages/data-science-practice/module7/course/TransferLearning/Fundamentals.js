...
const Fundamentals = () => {
  return (
    <>
      ...
      <div data-slide>
        <Title order={3} mb="md">Loading Pre-trained Models</Title>
...
print(f"ResNet-50 last layer: {resnet.fc}")

# Vision Transformer (ViT)
# Input: (batch_size, 3, 224, 224)
# Feature dimension: 768
vit = models.vit_b_16(weights=ViT_B_16_Weights.IMAGENET1K_V1)
print(f"ViT last layer: {vit.heads}")`}
        />
      ...
      <div data-slide>
        <Title order={3} mb="md">Modifying Model Architecture</Title>
