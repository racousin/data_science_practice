...
const Exercise1 = () => {
  const trainDataUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module7/exercise/module8_exercise_train.zip";
  const testDataUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module7/exercise/module8_exercise_test_features.csv";
  const notebookUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module7/exercise/module8_exercise1.ipynb";
  const notebookHtmlUrl = process.env.PUBLIC_URL + "/modules/data-science-practice/module7/exercise/module8_exercise1.html";
  const notebookColabUrl = process.env.PUBLIC_URL + "website/public/modules/data-science-practice/module7/exercise/module8_exercise1.ipynb";
