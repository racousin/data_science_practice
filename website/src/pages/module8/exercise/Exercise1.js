...
const Exercise1 = () => {
  const trainDataUrl = process.env.PUBLIC_URL + "/modules/module8/exercise/module8_exercise_train.zip";
  const testDataUrl = process.env.PUBLIC_URL + "/modules/module8/exercise/module8_exercise_test_features.csv";
  const notebookUrl = process.env.PUBLIC_URL + "/modules/module8/exercise/module8_exercise1.ipynb";
  const notebookHtmlUrl = process.env.PUBLIC_URL + "/modules/module8/exercise/module8_exercise1.html";
  const notebookColabUrl = process.env.PUBLIC_URL + "website/public/modules/module8/exercise/module8_exercise1.ipynb";
      ...
      <Stack spacing="lg">
        ...
        <Stack spacing="md">
          ...
          <CodeBlock
            code={`index,label\n0,4\n1,7\n2,2\n3,1\n...`}
          />
          <Text>Target accuracy threshold: 90% on the test set</Text>
        </Stack>
