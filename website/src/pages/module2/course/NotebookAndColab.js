  ...
  return (
    <Container fluid>
      ...
      <p>
        ...
        Colab for interactive data analysis and visualization.
      </p>
      <Row>
        <Col>
      ...
      <Row className="mt-4">
        <Col>
          ...
          <p>
            ...
            provides access to a variety of resources, including GPUs and TPUs.
          </p>
          <h3>Using Google Colab</h3>
          <p>
            To use Google Colab, go to{" "}
            <a
