...
import CourseGit from '../pages/data-science-practice/module1/CourseGit';
import ExerciseGit from '../pages/data-science-practice/module1/ExerciseGit';
import CoursePython from '../pages/data-science-practice/module2/CoursePython';
import ExercisePython from '../pages/data-science-practice/module2/ExercisePython';
import CourseDataScienceLandscape from '../pages/data-science-practice/module3/CourseDataScienceLandscape';
import ExerciseDataScienceLandscape from '../pages/data-science-practice/module3/ExerciseDataScienceLandscape';
import CourseDataCollection from '../pages/data-science-practice/module4/CourseDataCollection';
import ExerciseDataCollection from '../pages/data-science-practice/module4/ExerciseDataCollection';
import CourseDataPreprocessing from '../pages/data-science-practice/module5/CourseDataPreprocessing';
import ExerciseDataPreprocessing from '../pages/data-science-practice/module5/ExerciseDataPreprocessing';
import CourseTabularModels from '../pages/data-science-practice/module6/CourseTabularModels';
import ExerciseTabularModels from '../pages/data-science-practice/module6/ExerciseTabularModels';
import CourseDeepLearningFundamentals from '../pages/data-science-practice/module7/CourseDeepLearningFundamentals';
import ExerciseDeepLearningFundamentals from '../pages/data-science-practice/module7/ExerciseDeepLearningFundamentals';
import CourseImageProcessing from '../pages/data-science-practice/module8/CourseImageProcessing';
import ExerciseImageProcessing from '../pages/data-science-practice/module8/ExerciseImageProcessing';
import CourseTimeSeriesProcessing from '../pages/data-science-practice/module9/CourseTimeSeriesProcessing';
import ExerciseTimeSeriesProcessing from '../pages/data-science-practice/module9/ExerciseTimeSeriesProcessing';
import CourseTextProcessing from '../pages/data-science-practice/module10/CourseTextProcessing';
import ExerciseTextProcessing from '../pages/data-science-practice/module10/ExerciseTextProcessing';
import CourseGenerativeModels from '../pages/data-science-practice/module11/CourseGenerativeModels';
import ExerciseGenerativeModels from '../pages/data-science-practice/module11/ExerciseGenerativeModels';
import CourseRecommendationSystems from '../pages/data-science-practice/module12/CourseRecommendationSystems';
import ExerciseRecommendationSystems from '../pages/data-science-practice/module12/ExerciseRecommendationSystems';
import CourseReinforcementLearning from '../pages/data-science-practice/module13/CourseReinforcementLearning';
import ExerciseReinforcementLearning from '../pages/data-science-practice/module13/ExerciseReinforcementLearning';
import CourseDocker from '../pages/data-science-practice/module14/CourseDocker';
import ExerciseDocker from '../pages/data-science-practice/module14/ExerciseDocker';
import CourseCloudIntegration from '../pages/data-science-practice/module15/CourseCloudIntegration';
import ExerciseCloudIntegration from '../pages/data-science-practice/module15/ExerciseCloudIntegration';
